...
def openapi() -> dict:
    return {"openapi": "3.1.0", "info": {"title": "Orchestra-next API", "version": "1"}, "servers": [{"url": "http://127.0.0.1:8766/api"}], "paths": {"/runs": {}, "/profiles": {}, "/groups": {}, "/settings": {}, "/scheduler/pause": {}, "/scheduler/resume": {}, "/attention": {}, "/storage": {}}}
